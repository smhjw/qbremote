...
class TorrentRepository {
    ...
    suspend fun fetchGlobalSpeedLimits() = withBackend { fetchGlobalSpeedLimits() }
    suspend fun fetchGlobalSpeedLimits(profileId: String) =
        withBackend(profileId) { fetchGlobalSpeedLimits() }

    suspend fun setGlobalSpeedLimits(
        downloadLimit: Long,
        uploadLimit: Long,
        altDownloadLimit: Long,
        altUploadLimit: Long,
        schedulerEnabled: Boolean = false,
        scheduleFromHour: Int = 8,
        scheduleFromMin: Int = 0,
        scheduleToHour: Int = 20,
        scheduleToMin: Int = 0,
        schedulerDays: Int = 0,
    ) = withBackend { setGlobalSpeedLimits(downloadLimit, uploadLimit, altDownloadLimit, altUploadLimit, schedulerEnabled, scheduleFromHour, scheduleFromMin, scheduleToHour, scheduleToMin, schedulerDays) }
    ...
    suspend fun setGlobalSpeedLimits(
        ...
        scheduleToMin: Int = 0,
        schedulerDays: Int = 0,
    ) = withBackend(profileId) { setGlobalSpeedLimits(downloadLimit, uploadLimit, altDownloadLimit, altUploadLimit, schedulerEnabled, scheduleFromHour, scheduleFromMin, scheduleToHour, scheduleToMin, schedulerDays) }

    suspend fun toggleAltSpeedMode() = withBackend { toggleAltSpeedMode() }
    suspend fun toggleAltSpeedMode(profileId: String) =
        withBackend(profileId) { toggleAltSpeedMode() }
