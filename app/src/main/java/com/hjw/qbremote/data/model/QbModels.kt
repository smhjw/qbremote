...
data class GlobalSpeedLimits(
    val downloadLimit: Long = 0,      // bytes/s, 0=不限
    val uploadLimit: Long = 0,        // bytes/s, 0=不限
    val altDownloadLimit: Long = 0,   // bytes/s, 0=不限
    val altUploadLimit: Long = 0,     // bytes/s, 0=不限
    val useAltSpeedLimits: Boolean = false,
    // 调度
    val schedulerEnabled: Boolean = false,
    val scheduleFromHour: Int = 8,
    val scheduleFromMin: Int = 0,
    val scheduleToHour: Int = 20,
    val scheduleToMin: Int = 0,
    val schedulerDays: Int = 0,  // 0=每天,1=工作日,2=周末,3-9=周一~周日
)
